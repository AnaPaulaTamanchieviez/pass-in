    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="px-3 w-72 py-1.5 border border-white/10 bg-transparent rounded-lg flex item-center gap-3">
                    ...
                    <TableRow key={attendee.id} className="border-b border-white/10 hover:bg-white/5">
                        ...
                        <TableCell>
                            {attendee.checkedInAt === null 
                              ? <span className="text-zinc-400">Haven't checked in yet</span>
